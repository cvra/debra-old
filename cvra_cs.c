...
void cvra_cs_init(void) {
	...
	rs_set_left_ext_encoder(&robot.rs, cvra_dc_get_encoder0, HEXMOTORCONTROLLER_BASE, 1.00072598);
	rs_set_right_ext_encoder(&robot.rs, cvra_dc_get_encoder5, HEXMOTORCONTROLLER_BASE,-0.99927390);
#endif
	...
	position_set_physical_params(&robot.pos,177.70530701, 
			160.396); // imp / mm  //
    ...
    /* Swisseurobot. */
	trajectory_set_acc(&robot.traj, acc_mm2imp(&robot.traj, 1300), acc_rd2imp(&robot.traj, 10));
